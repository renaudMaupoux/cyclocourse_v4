/**
 * Web Speech API (Chrome / Edge / Safari récent) — reconnaissance locale côté navigateur.
 * Les résultats finaux sont envoyés au backend via /api/voice/recognize-text.
 */
